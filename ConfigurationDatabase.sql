...
CREATE TABLE IF NOT EXISTS `Config`.`DataURI` (
  `DataURIID` INT(11) NOT NULL AUTO_INCREMENT,
  `DataSourceID` INT(11) NULL DEFAULT NULL,
  `AttributeID` INT(11) NULL DEFAULT NULL,
  `DataURIName` VARCHAR(255) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `Config`.`BensNewTable`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Config`.`BensNewTable` (
  `idBensNewTable` INT NOT NULL,
  PRIMARY KEY (`idBensNewTable`))
ENGINE = InnoDB;
